...
class _TestFormBuilderState extends State<TestFormBuilder> {
  ...
  @override
  void initState() {
    _formModel = TestForm(TestForm.formElements(widget.model), null, null);
...
class TestForm implements FormModel<Test, Test> {
  TestForm(this.form, this.path, this._formModel) : initial = form.rawValue;
  ...
  void updateValue(
    ...
    TestForm.formElements(value).rawValue,
    updateParent: updateParent,
    emitEvent: emitEvent,
  );
  ...
  void upsertValue(
    ...
    final formElements = TestForm.formElements(value);

    currentForm.addAll(formElements.controls);
  }

  @override
  void reset({Test? value, bool updateParent = true, bool emitEvent = true}) =>
      currentForm.reset(
...
class ReactiveTestFormArrayBuilder<ReactiveTestFormArrayBuilderT>
  ...
  final bool Function(FormControl<ReactiveTestFormArrayBuilderT> control)?
  controlFilter;
  ...
  Widget build(BuildContext context) {
    ...
    return ReactiveFormArrayItemBuilder<ReactiveTestFormArrayBuilderT>(
...
class ReactiveTestFormArrayBuilder2<ReactiveTestFormArrayBuilderT>
    extends StatelessWidget {
  const ReactiveTestFormArrayBuilder2({
    Key? key,
    this.control,
    this.formControl,
    this.builder,
  ...
  final Widget Function(
    ({BuildContext context, List<Widget> itemList, TestForm formModel}) params,
  )?
  builder;
