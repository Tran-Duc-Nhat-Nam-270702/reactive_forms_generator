...
class LoginExtendedForm implements FormModel<LoginExtended, LoginExtended> {
  LoginExtendedForm(this.form, this.path, this._formModel)
  ...
  void upsertValue(
    ...
    final formElements = LoginExtendedForm.formElements(value);
...
class ReactiveLoginExtendedFormArrayBuilder<
  ReactiveLoginExtendedFormArrayBuilderT
>
  ...
  Widget build(BuildContext context) {
    ...
    return ReactiveFormArrayItemBuilder<ReactiveLoginExtendedFormArrayBuilderT>(
...
>
  ...
  final Widget Function(
    ({BuildContext context, List<Widget> itemList, LoginExtendedForm formModel})
    params,
  )?
  builder;
...
>
  ...
  final ExtendedControl<
    ...
    List<ReactiveLoginExtendedFormFormGroupArrayBuilderT>
  >
  Function(LoginExtendedForm formModel)?
  getExtended;
